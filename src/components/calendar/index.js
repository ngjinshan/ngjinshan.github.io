...
const Calendar = () => {
  ...
  const renderProjects = (project, index) => {
    ...
    return (
      <div
        key={index}
        className="col-3 calendar-box"
        onClick={() => setEmpty()}
        style={{ cursor: `${project.detail ? "pointer" : "initial"}` }}
      >
        ...
        {month && (
          <div
            ...
            style={{
              display: `${
                month === project.month && year === project.year
                  ? "initial"
                  : "none"
              }`,
              marginLeft: (index + 1) % 4 === 0 ? "" : calculateMarginLeft,
  ...
  return (
    <>
      ...
      <div className="calendar-mobile">
        <div
          className="calendar-mobile-container"
          style={{ height: "100%", overflowY: "auto" }}
        >
