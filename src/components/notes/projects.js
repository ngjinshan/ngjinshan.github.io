export const projects = [
    {
        ...
        suggested the idea of a website to automate things instead.`,
        ...
        using Axios interceptors and use refresh tokens with access tokens where users can be disconnected in real time if needed.`,
