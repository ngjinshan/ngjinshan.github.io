...
const Notes = () => {
  ...
  const renderNoteSimplifiedMobile = (data, index) => {
    return (
      <div key={index}>
        <div
          className="note-simplified"
          onClick={() => setMobileActive(experience[index])}
        >
          <div
            style={{
              display: "flex",
  ...
  return (
    <>
      ...
      >
        <div
          className="col-12 note-left-panel"
          style={{ paddingTop: ".5em", paddingBottom: "1.5em", height: "100%" }}
        >
          <div
            className="row"
            style={{
              ...
              <div style={{ display: "flex", justifyContent: "space-between" }}>
                {mobileActive && (
                  <div onClick={() => setMobileActive()}>
                    <span style={{ fontSize: "x-large", fontWeight: "700" }}>
                      &#60;
                    </span>
                  </div>
                )}
          ...
          >
            {experience.map(renderNoteSimplifiedMobile)}
          </div>
          <div
            className="note-detail-mobile"
            style={{ display: `${mobileActive ? "initial" : "none"}` }}
          >
